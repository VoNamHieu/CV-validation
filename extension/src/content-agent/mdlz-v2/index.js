...
export async function runMdlzV2(ctx = {}) {
    ...
    // Multi-pass interaction watchdog (see interaction-watchdog.js): a widget
    // stuck in an interaction result for INTERACTION_STUCK_PASSES passes running
    // is resolved — OPTIONAL skipped so the page completes over it, REQUIRED left
    // for the outer loop to escalate — instead of looping to the runtime cap.
    {
