        ...
        >
            ...
            >
                ...
                <p style={{ fontSize: '0.82rem', color: 'var(--text-secondary)', lineHeight: 1.6, margin: '0 0 14px' }}>
                    JobFit sẽ thay bạn điền và có thể nộp đơn ứng tuyển trên trang tuyển dụng. Kết quả AI có
                ...
                <label style={{
                    ...
                    />
                    <span>
                        Tôi hiểu rằng JobFit tự động điền/nộp đơn thay tôi và tôi chịu trách nhiệm về nội dung
                        được gửi đi.
                    </span>
                </label>
