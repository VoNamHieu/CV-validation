...
// Shown when the user triggers an auto-apply action without the JobFit Chrome
...
const STEPS = [
    'Tải & cài extension JobFit cho Chrome từ link bên dưới.',
        ...
        >
            ...
            >
                ...
                <h2 style={{ fontSize: '1.05rem', fontWeight: 700, marginBottom: 6, color: 'var(--text-primary)' }}>
                    Cần cài extension JobFit
                </h2>
                <p style={{ fontSize: '0.82rem', color: 'var(--text-muted)', marginBottom: 16, lineHeight: 1.55 }}>
                    Tính năng tự động ứng tuyển cần extension JobFit cho Chrome để điền form trên trang
                ...
                >
                    <ArrowSquareOut size={17} weight="bold" /> Cài extension JobFit
                </a>
